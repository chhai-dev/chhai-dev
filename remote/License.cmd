...
cls
color 07
title  Microsoft Activation Tools
...
cls
color 07
title  Microsoft License Activation Tools
mode 76, 30
...
echo:
call :_color2 %_White% "       *             " %_Green% "        Activation Tools                       *"
echo:       ______________________________________________________________
echo:
echo:             [1] License Windows and Office 180 Days
...
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "       *             " %_Green% "Developed by Mr.Chhai PTC Computer             *"
echo:       ______________________________________________________________
